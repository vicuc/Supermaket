...
<div class="agileits_header">
		...
		<div class="w3l_search">
			<form action="/tim-kiem" method="POST"> {{ csrf_field() }}
					
		        	<input style="width: 50%;" type="search" name="tukhoa"  class="form-control" placeholder="Seach....." required="" />
		...
		<div class="product_list_header">  
            <a style="margin-top: 8px; background-color:#03a9f4;" href="/gio-hang" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> {{Cart::count()}} sản phẩm</a>
		</div>
	...
	<div class="logo_products">
		...
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="/"><span style="color: #03a9f4">Bánh Bao</span> Store</a></h1>
			</div>
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					<li><a href="events.html">Sự kiện</a><i>/</i></li>
					<li><a href="about.html">Giới thiệu</a><i>/</i></li>
					<li><a href="products.html">Ưu đãi tốt</a><i>/</i></li>
					<li><a href="services.html">Dịch vụ</a></li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>(076) 299 9994</li> &nbsp&nbsp
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com">banhbao@gmail.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
		...
		<div class="container">
			...
			<div class="col-md-4 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list">
					...
					<li><a href="privacy.html">Chính sạch bảo mật</a></li>
