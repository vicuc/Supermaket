@extends('page.layout')
@section('tieude','Sản phẩm nước ép')
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" width="190px" height="190px" style="margin-left: 10%" src="{{asset('public/admin/upload/hang-hoa/')}}/{{$nuocep->hinh_anh}}" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>{{ number_format($nuocep->gia_hh,0) }}đ <span>{{ number_format($nuocep->gia_km,0) }}đ</span></h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
								<fieldset>
									
									<a href="{{Route('addcart',['id' => $nuocep->id])}}" class="btn btn-primary" style="background-color: #03a9f4"/>Thêm vào giỏ hàng</a>
								</fieldset>
							</form>
						</div>
					</div>
