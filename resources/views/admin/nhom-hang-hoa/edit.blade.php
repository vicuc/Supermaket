                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                            <form action="/admin/danh-sach-nhom-hang-hoa/sua-nhom-hang-hoa-
                            {{$nhomhanghoa->id}}.html" id="form_validation" method="POST" >
                                {{csrf_field() }}
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Sửa nhóm hàng hóa</strong>
                                        <a href="{{Route('nhh1')}}" style="float:right">Quay lại</a>
                                    </div>
                                    <div class="card-body card-block">
                                            <div class="form-group">
                                                <label  class=" form-control-label">Tên nhóm hàng hóa</label>
                                                <input type="text" value="{{$nhomhanghoa->ten_nhom}}" name="ten" placeholder="Tên nhóm hàng hóa" class="form-control">
